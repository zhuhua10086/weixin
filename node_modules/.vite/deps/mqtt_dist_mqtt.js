import {
  ...
  __privateWrapper,
  __publicField
} from "./chunk-GMSMCCHJ.js";

// C:/Users/24673/Desktop/新建文件夹 (7)/k/uniapp-vue3-ui-master/node_modules/mqtt/dist/mqtt.js
var mqtt = (() => {
...
`;
  ...
  var require_cjs = __commonJS({
    "node_modules/lru-cache/dist/cjs/index.js"(exports5) {
      var _a, _b, _constructing, _max, _maxSize, _dispose, _disposeAfter, _fetchMethod, _size, _calculatedSize, _keyMap, _keyList, _valList, _next, _prev, _head, _tail, _free, _disposed, _sizes, _starts, _ttls, _hasDispose, _hasFetchMethod, _hasDisposeAfter, _initializeTTLTracking, initializeTTLTracking_fn, _updateItemAge, _statusTTL, _setItemTTL, _isStale, _initializeSizeTracking, initializeSizeTracking_fn, _removeItemSize, _addItemSize, _requireSize, _indexes, indexes_fn, _rindexes, rindexes_fn, _isValidIndex, isValidIndex_fn, _evict, evict_fn, _backgroundFetch, backgroundFetch_fn, _isBackgroundFetch, isBackgroundFetch_fn, _connect, connect_fn, _moveToTail, moveToTail_fn, _c;
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
      ...
      __privateAdd(_b, _constructing, false), _b);
      var LRUCache = (_c = class {
        constructor(options) {
          ...
          if (!this.ttlAutopurge && !__privateGet(this, _max) && !__privateGet(this, _maxSize)) {
            ...
            if (shouldWarn(code)) {
              ...
              emitWarning2(msg, "UnboundedCacheWarning", code, _c);
            }
          }
        }
        /**
        ...
        static unsafeExposeInternals(c6) {
          return {
            ...
            isBackgroundFetch: (p6) => {
              var _a2;
              return __privateMethod(_a2 = c6, _isBackgroundFetch, isBackgroundFetch_fn).call(_a2, p6);
            },
            backgroundFetch: (k2, index, options, context) => {
              var _a2;
              return __privateMethod(_a2 = c6, _backgroundFetch, backgroundFetch_fn).call(_a2, k2, index, options, context);
            },
            moveToTail: (index) => {
              var _a2;
              return __privateMethod(_a2 = c6, _moveToTail, moveToTail_fn).call(_a2, index);
            },
            indexes: (options) => {
              var _a2;
              return __privateMethod(_a2 = c6, _indexes, indexes_fn).call(_a2, options);
            },
            rindexes: (options) => {
              var _a2;
              return __privateMethod(_a2 = c6, _rindexes, rindexes_fn).call(_a2, options);
            },
            isStale: (index) => {
              var _a2;
              return __privateGet(_a2 = c6, _isStale).call(_a2, index);
            }
          };
        }
         ...
         */
        *entries() {
          for (const i6 of __privateMethod(this, _indexes, indexes_fn).call(this)) {
            if (__privateGet(this, _valList)[i6] !== void 0 && __privateGet(this, _keyList)[i6] !== void 0 && !__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, __privateGet(this, _valList)[i6])) {
              yield [__privateGet(this, _keyList)[i6], __privateGet(this, _valList)[i6]];
            }
          }
        }
        /**
         ...
         */
        *rentries() {
          for (const i6 of __privateMethod(this, _rindexes, rindexes_fn).call(this)) {
            if (__privateGet(this, _valList)[i6] !== void 0 && __privateGet(this, _keyList)[i6] !== void 0 && !__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, __privateGet(this, _valList)[i6])) {
              yield [__privateGet(this, _keyList)[i6], __privateGet(this, _valList)[i6]];
            }
          }
        ...
        *keys() {
          for (const i6 of __privateMethod(this, _indexes, indexes_fn).call(this)) {
            const k2 = __privateGet(this, _keyList)[i6];
            if (k2 !== void 0 && !__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, __privateGet(this, _valList)[i6])) {
              yield k2;
            }
          }
        }
        ...
        *values() {
          for (const i6 of __privateMethod(this, _indexes, indexes_fn).call(this)) {
            const v4 = __privateGet(this, _valList)[i6];
            if (v4 !== void 0 && !__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, __privateGet(this, _valList)[i6])) {
              yield __privateGet(this, _valList)[i6];
            }
          }
        }
        /**
        ...
        *rvalues() {
        ...
        find(fn, getOptions = {}) {
          for (const i6 of __privateMethod(this, _indexes, indexes_fn).call(this)) {
            ...
            if (value === void 0)
              continue;
            if (fn(value, __privateGet(this, _keyList)[i6], this)) {
              return this.get(__privateGet(this, _keyList)[i6], getOptions);
            }
          }
        }
        /**
        ...
        forEach(fn, thisp = this) {
          for (const i6 of __privateMethod(this, _indexes, indexes_fn).call(this)) {
            ...
            if (value === void 0)
              continue;
            fn.call(thisp, value, __privateGet(this, _keyList)[i6], this);
          }
        }
        /**
        ...
        purgeStale() {
          let deleted = false;
          for (const i6 of __privateMethod(this, _rindexes, rindexes_fn).call(this, { allowStale: true })) {
            if (__privateGet(this, _isStale).call(this, i6)) {
              this.delete(__privateGet(this, _keyList)[i6]);
              deleted = true;
            }
          }
          return deleted;
        ...
        dump() {
          const arr = [];
          for (const i6 of __privateMethod(this, _indexes, indexes_fn).call(this, { allowStale: true })) {
            const key = __privateGet(this, _keyList)[i6];
            const v4 = __privateGet(this, _valList)[i6];
            const value = __privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, v4) ? v4.__staleWhileFetching : v4;
            ...
            if (__privateGet(this, _ttls) && __privateGet(this, _starts)) {
              entry.ttl = __privateGet(this, _ttls)[i6];
              const age = perf.now() - __privateGet(this, _starts)[i6];
              entry.start = Math.floor(Date.now() - age);
            }
            if (__privateGet(this, _sizes)) {
              entry.size = __privateGet(this, _sizes)[i6];
            }
        ...
        set(k2, v4, setOptions = {}) {
          ...
          const size = __privateGet(this, _requireSize).call(this, k2, v4, setOptions.size || 0, sizeCalculation);
              ...
              if (__privateGet(this, _hasFetchMethod) && __privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, oldVal)) {
                ...
                if (s5 !== void 0 && !noDisposeOnSet) {
                  if (__privateGet(this, _hasDispose)) {
                    (_a2 = __privateGet(this, _dispose)) == null ? void 0 : _a2.call(this, s5, k2, "set");
                  }
                  if (__privateGet(this, _hasDisposeAfter)) {
                    (_b2 = __privateGet(this, _disposed)) == null ? void 0 : _b2.push([s5, k2, "set"]);
                  }
                }
              } else if (!noDisposeOnSet) {
                if (__privateGet(this, _hasDispose)) {
                  (_c2 = __privateGet(this, _dispose)) == null ? void 0 : _c2.call(this, oldVal, k2, "set");
                }
                if (__privateGet(this, _hasDisposeAfter)) {
        ...
        async fetch(k2, fetchOptions = {}) {
          ...
          if (index === void 0) {
            if (status)
              status.fetch = "miss";
            const p6 = __privateMethod(this, _backgroundFetch, backgroundFetch_fn).call(this, k2, index, options, context);
            ...
            if (index !== void 0) {
              ...
              if (__privateGet(this, _size) === 1) {
                ...
                if (__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, v4)) {
                  ...
                  if (__privateGet(this, _hasDispose)) {
                    (_a2 = __privateGet(this, _dispose)) == null ? void 0 : _a2.call(this, v4, k2, "delete");
                  }
                  if (__privateGet(this, _hasDisposeAfter)) {
                    (_b2 = __privateGet(this, _disposed)) == null ? void 0 : _b2.push([v4, k2, "delete"]);
                  }
                }
      ...
      }, _updateItemAge = new WeakMap(), _statusTTL = new WeakMap(), _setItemTTL = new WeakMap(), _isStale = new WeakMap(), _initializeSizeTracking = new WeakSet(), initializeSizeTracking_fn = function() {
        ...
        __privateSet(this, _requireSize, (k2, v4, size, sizeCalculation) => {
          if (__privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, v4)) {
            return 0;
          }
          if (!isPosInt(size)) {
      ...
      }, _removeItemSize = new WeakMap(), _addItemSize = new WeakMap(), _requireSize = new WeakMap(), _indexes = new WeakSet(), indexes_fn = function* ({ allowStale = this.allowStale } = {}) {
        if (__privateGet(this, _size)) {
          for (let i6 = __privateGet(this, _tail); true; ) {
            if (!__privateMethod(this, _isValidIndex, isValidIndex_fn).call(this, i6)) {
              break;
            }
            if (allowStale || !__privateGet(this, _isStale).call(this, i6)) {
              yield i6;
            }
            if (i6 === __privateGet(this, _head)) {
              break;
            } else {
              i6 = __privateGet(this, _prev)[i6];
            }
          }
        }
      }, _rindexes = new WeakSet(), rindexes_fn = function* ({ allowStale = this.allowStale } = {}) {
        if (__privateGet(this, _size)) {
          for (let i6 = __privateGet(this, _head); true; ) {
            if (!__privateMethod(this, _isValidIndex, isValidIndex_fn).call(this, i6)) {
              break;
            }
            if (allowStale || !__privateGet(this, _isStale).call(this, i6)) {
            ...
            if (i6 === __privateGet(this, _tail)) {
              break;
            } else {
              i6 = __privateGet(this, _next)[i6];
            }
          }
        }
      }, _isValidIndex = new WeakSet(), isValidIndex_fn = function(index) {
        return index !== void 0 && __privateGet(this, _keyMap).get(__privateGet(this, _keyList)[index]) === index;
      }, _evict = new WeakSet(), evict_fn = function(free) {
        var _a2, _b2;
        ...
        if (__privateGet(this, _hasFetchMethod) && __privateMethod(this, _isBackgroundFetch, isBackgroundFetch_fn).call(this, v4)) {
          ...
          if (__privateGet(this, _hasDispose)) {
            (_a2 = __privateGet(this, _dispose)) == null ? void 0 : _a2.call(this, v4, k2, "evict");
          }
          if (__privateGet(this, _hasDisposeAfter)) {
            (_b2 = __privateGet(this, _disposed)) == null ? void 0 : _b2.push([v4, k2, "evict"]);
          }
        }
        ...
        __privateWrapper(this, _size)._--;
        return head;
      }, _backgroundFetch = new WeakSet(), backgroundFetch_fn = function(k2, index, options, context) {
        ...
        const cb = (v5, updateCache = false) => {
          ...
          const bf2 = p6;
          if (__privateGet(this, _valList)[index] === p6) {
            if (v5 === void 0) {
        ...
        const pcall = (res, rej) => {
          var _a2;
          const fmp = (_a2 = __privateGet(this, _fetchMethod)) == null ? void 0 : _a2.call(this, k2, v4, fetchOpts);
        ...
        return bf;
      }, _isBackgroundFetch = new WeakSet(), isBackgroundFetch_fn = function(p6) {
        if (!__privateGet(this, _hasFetchMethod))
          return false;
        const b3 = p6;
        return !!b3 && b3 instanceof Promise && b3.hasOwnProperty("__staleWhileFetching") && b3.__abortController instanceof AC;
      }, _connect = new WeakSet(), connect_fn = function(p6, n7) {
        __privateGet(this, _prev)[n7] = p6;
        __privateGet(this, _next)[p6] = n7;
      }, _moveToTail = new WeakSet(), moveToTail_fn = function(index) {
        if (index !== __privateGet(this, _tail)) {
